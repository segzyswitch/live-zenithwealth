...
<head>
	...
	<title>Velloxa Wealth - Change Password
	</title>
								...
								<div class="site-card">
									<div class="site-card-header">
										...
										<div class="card-header-links">
											<a href="https://zenithwealthpro.com/account/user/settings" class="card-header-link">Back</a>
										</div>
									</div>
									<div class="site-card-body">
										<div class="progress-steps-form">
											<form action="https://zenithwealthpro.com/account/user/password-store" method="post">
